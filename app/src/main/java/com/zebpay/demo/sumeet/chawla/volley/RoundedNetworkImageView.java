...
public class RoundedNetworkImageView extends RoundedImageView {
     ...
     * {@link RoundedNetworkImageView#setDefaultImageResId(int)} on the view.
     * <p/>
     * NOTE: If applicable, {@link RoundedNetworkImageView#setDefaultImageResId(int)} and
     * {@link RoundedNetworkImageView#setErrorImageResId(int)} should be called prior to calling
     * this function.
     *
